    ...
    for y in range(min_y, max_y):
        ...
        for x in range(min_x, max_x):
            ...
            if alpha>=0 and beta >= 0 and gamma >= 0:
                ...
                color = np.array(3*[min(255,255*(max(n1[0]*LIGHT_VECTOR[0]+n1[1]*LIGHT_VECTOR[1]+n1[2]*LIGHT_VECTOR[2],0)*alpha+max(n2[0]*LIGHT_VECTOR[0]+n2[1]*LIGHT_VECTOR[1]+n2[2]*LIGHT_VECTOR[2],0)*beta+ max(n3[0]*LIGHT_VECTOR[0]+n3[1]*LIGHT_VECTOR[1]+n3[2]*LIGHT_VECTOR[2],0)*gamma)+parameters.AMBIENT_INTENSITY)])
    ...
    for y in range(min_y, max_y):
        ...
        for x in range(min_x, max_x):
            ...
            if alpha>=0 and beta >= 0 and gamma >= 0:
                ...
                intensity = np.array(3*[min(255,255*(max(n1[0]*LIGHT_VECTOR[0]+n1[1]*LIGHT_VECTOR[1]+n1[2]*LIGHT_VECTOR[2],0)*alpha+max(n2[0]*LIGHT_VECTOR[0]+n2[1]*LIGHT_VECTOR[1]+n2[2]*LIGHT_VECTOR[2],0)*beta+ max(n3[0]*LIGHT_VECTOR[0]+n3[1]*LIGHT_VECTOR[1]+n3[2]*LIGHT_VECTOR[2],0)*gamma)+parameters.AMBIENT_INTENSITY)],)

                color = np.array([base[2] * intensity, base[1] * intensity, base[0] * intensity],dtype=np.uint8)
